...
<html><head>
    ...
    <link href="http://localhost/css/styleL.css" rel="stylesheet" type="text/css">
  </head><body>
          ...
          <div class="col-md-12">
            <form role="form">
              <div class="form-group">
                ...
                <input class="form-control" id="exampleInputEmail1" placeholder="imail machinÁ" type="text" name="“txtusuario”">
              </div>
              <div class="form-group">
                <label class="control-label" for="exampleInputPassword1">Contraseña</label>
                <input class="form-control" id="exampleInputPassword1" placeholder="Ejemplo: &quot;Pentakill5&quot;" type="password" name="“txtpassword”">
              </div>
